<div class="container">
   <div class="row" style="padding-top: 50px">
       <div class="col-lg-12">
        ...
        ?>
        <tr><td colspan="5"><span style="float:right;text-align: right;"><?php echo $shipping_cost; ?>Amount Payable : <?php echo $currency .sprintf("%01.2f", $grand_total);?></span></td></tr>
        <tr><td colspan="5">
                <a href="Main.php" class="btn btn-primary">Add More Items</a>
                <p></p>
