        ...
        <div class="card" align="center">
            <div class="card-block">
                ...
                <form method="post" action="register_ps.php" class="col-lg-4">
                    ...
                    <textarea type='text' name='address' class="form-control" id='address' maxlength="50" placeholder="Address" required></textarea><br/>
                    ...
                    <div class="accounttype" align="absolute">
                        <p style="padding-top: 5px;">Select Account Type:</p>
